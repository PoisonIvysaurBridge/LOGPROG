...
while cont:
    print('\n------------ MAIN MENU ------------')
    print('1. Setup\n2. Start Day\n3. Exit\n')
    Option=int(input('Please choose and option (1, 2, or 3): '))
...
############
        ...
        while ReturnSD:
            ...
            if SD==1:
                print('\n============ Restock Inventory ============')
                IBB= int(input('Enter BURGER BUN Qty: '))
                IBP= int(input('Enter BEEF BURGER PATTY Qty: '))
                ICP= int(input('Enter CHICKEN BURGER PATTY Qty: '))
                IRF= int(input('Enter REGULAR FRIES Qty: '))
                ILF= int(input('Enter LARGE FRIES Qty: '))
                IBW= int(input('Enter BURGER WRAP Qty: '))
                IRSC= int(input('Enter REGULAR SODA CUP Qty: '))
                ILSC= int(input('Enter LARGE SODA CUP Qty: '))
...
############   
                ...
                while accept: # new customer
                    ...
                    if IBB>0 and IBP>0 and ICP>0 and IRF>0 and ILF>0 and IBW>0 and IRSC>0 and ILSC>0: #checks Inventory first before proceeding to receipt
                        customer+=1
                    #Generation of customer's receipt
                        ...
                        print('OH NO NOT ENOUGH INVENTORY PLS RESTOCK IMMEDIATELY') 
                        accept=False
